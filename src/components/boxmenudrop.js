    ...
    <div className="dropdown" onClick={handleToggle} ref={wrapperRef}>
      ...
      >
        <div className="drop-item">
          ...
          <a className="drop-link" href="mailto:manojvk2002@gmail.com">
            <img
              src={email}
              alt=""
            />
          ...
          <a className="drop-link" href="https://github.com/Manoj3001">
            <img
              src={gh}
              alt=""
            />
          ...
          <a className="drop-link" href="https://www.linkedin.com/in/manoj-vijaykumar-0863481b4/">
            <img
              src={li}
              alt=""
            />
